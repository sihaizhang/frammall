...
<div>
        <ul class="nav nav-tabs">
                ...
                <li class="dropdown active"><a href="###" class="dropdown" data-toggle="dropdown">卖家中心
                        ...
                        <ul class="dropdown-menu">
                                <li class="active"><a href="${APP_PATH}/jsp/free_opening.jsp">免费开店</a></li>
                ...
                <div class="prove row">
                        <form class="form-horizontal">
                                <div class="form-group">
                                        <label class="col-md-2 control-label">您注册的昵称：</label>
                                        <div class="col-md-6"><input class="form-control" placeholder="请输入昵称" type="text"></div>
                                </div>
                                <div class="form-group">
                                        <label class="col-md-2 control-label">您注册的密码：</label>
                                        <div class="col-md-6"><input class="form-control" type="password"></div>
                                </div>
                                <div class="form-group">
                                        <label class="col-md-2 control-label">您的真实姓名：</label>
                                        <div class="col-md-6"><input class="form-control" type="text" placeholder="请输入姓名"></div>
                                </div>
                                <div class="form-group">
                                        <label class="col-md-2 control-label">您注册时的邮箱：</label>
                                        <div class="col-md-6"><input class="form-control" type="email" placeholder="请输入邮箱"></div>
                                </div>
                                <div class="form-group">
                                        <label class="col-md-2 control-label">您注册时的手机号：</label>
                                        <div class="col-md-6"><input class="form-control" type="tel" placeholder="请输入手机号"></div>
                                </div>
                                <div class="form-group">
                                        <label class="col-md-2 control-label">您申请的店铺名：</label>
                                        <div class="col-md-6"><input class="form-control" type="tel" placeholder="请输入店铺名"></div>
                                </div>
                        </form>
                        <div class="apply"><button class="btn btn-danger">提交认证申请</button><button class="btn btn-info" style="margin-left: 180px;">放弃申请</button></div>
                </div>
        </div>
</div>
<footer id="footer">
