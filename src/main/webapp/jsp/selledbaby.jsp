        ...
        <ul class="nav nav-tabs">
                ...
                <li class="dropdown active"><a href="###" class="dropdown" data-toggle="dropdown">卖家中心
                        ...
                        <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="${APP_PATH}/jsp/selledbaby.jsp">已卖出的宝贝</a></li>
...
<div class="head">
        <ul>
                ...
                <li><div style="margin-left: 50px;background-color: rgba(0,0,0,0.1);"><a href="${APP_PATH}/jsp/selledbaby.jsp">已卖出的宝贝</a></div>
                </li>
...
<div class="box">
        <div class="col-md-2 aside">
                ...
                <div class="row" style="padding-left: 10px;padding-top: 20px;">
                        ...
                        <div style="padding-left: 28px;padding-top: 10px;"><a href="${APP_PATH}/jsp/selledbaby.jsp" style="color: rgba(247,91,93,1.00);">已卖出的宝贝</a></div>
                </div>
                <div class="row" style="padding-left: 10px;padding-top: 20px;">
        ...
        <div class="col-md-10 middle">
                <div class="row">
                        <div class="seller">我是卖家&nbsp;&gt;&nbsp;交易管理&nbsp;&gt;&nbsp;已卖出的宝贝&nbsp;&gt;&nbsp;全部订单</div>
                </div>
                <hr size="1px">
                <div class="row">
                        <ul class="nav nav-pills">
                                ...
                                <li><a href="#">等待发货</a></li>
                                <li><a href="#">已发货</a></li>
                                <li><a href="#">成功的订单</a></li>
                                <li><a href="#">关闭的订单</a></li>
                        </ul>
                </div>
                <div class="row">
                        <table class="table table-bordered text-center">
                                ...
                                <%--<c:forEach begin="1" end="4">
                                        <tr>
                                                <td>
                                                        <div>
                                                                <img src="${APP_PATH}/static/images/myorders/figure1.png" alt="" class="img-thumbnail">
                                                        </div>
                                                </td>
                                                <td>
                                                        <div>
                                                ...
                                                <td>
                                                        <div style="width: 60px;">
                                                                  <button class="btn btn-default" style="margin-left: 5px;">删除</button>
                                                        </div>
                                                </td>
                                        </tr>
                                </c:forEach>--%>
...
<script type="text/javascript">
        ...
        function analysisInfo(result) {
            ...
            $.each(orderList,function (index,orderItem) {
               ...
               var productNameTd = $("<td></td>").append($("<div></div>").append($("<a href='#'></a>").append(orderItem.productName).attr("product_id",orderItem.productId)));
               ...
               var statusTd = $("<td></td>").append(orderItem.status);
               var totalPriceTd = $("<td></td>").append(orderItem.totalPrice);
               var deleteBtn = $("<button class='btn btn-danger' style='margin-left:5px'>删除</button>").attr("order_no",orderItem.orderNo);
               var btnTd = $("<td></td>").append($("<div style='width: 60px'></div>").append(deleteBtn));
