...
<div>
        <ul class="nav nav-tabs">
                ...
                <li  style="padding-left: 250px" class="active" ><a href="${APP_PATH}/index.jsp"><span class="glyphicon glyphicon-home"></span>首页</a></li>
...
<div class="head">
        <ul>
                <li><div><img src="${APP_PATH}/static/images/myfavoritestore/img3.jpg" alt=""></div></li>
                <li>
                        <h3 id="shop_name"></h3>
                </li>
        </ul>
...
<div class="box">
        <div class="row">
                ...
                <div class="col-md-5">
                        <div>
                                <h4 style="text-align: center;"><strong>${sessionScope.currentProduct.name}</strong></h4>
                                <p>${sessionScope.currentProduct.subtitle}</p>
                                <p>${sessionScope.currentProduct.detail}</p>
                        </div>
                        <div class="price">价格<span><strong>￥${sessionScope.currentProduct.price}/kg</strong></span></div>
                        <div style="padding-top: 20px;">数量
                                <div class="btn-group" style="text-align: center;padding-left: 100px;" >
                                        <button type="button" value="+" class="btn btn-default" onClick="numDec()">-</button>
                                        <input value="1" id="quantity" type="text" class="btn btn-default" id="quantity" style="width: 50px;"/>
                                        <button type="button" value="-" class="btn btn-default" onClick="numAdd()">+</button>
                                </div>
                        </div>
                        <div style="padding-top: 20px;">
                                <%--<button id="create_order_btn" class="btn btn-default" style="background-color: rgba(213,211,150,0.3);width: 100px;">立即购买</button>--%>
                                <button id="add_cart_btn" class="btn btn-danger" style="margin-left: 50px;width: 200px;">
                ...
                <div class="col-md-3">
                        <div class="col-md-8 rig" >
                                ...
                                <%--<div class="row" style="padding-top: 40px;"><a href="#">进入店铺</a>
                                        <a href="#" style="padding-left: 20px;">收藏店铺</a>
                                </div>--%>
                        </div>
                        <div class="col-md-4">
