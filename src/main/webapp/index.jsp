...
<div class="container bigbox">
        <div class="row">
                ...
                <div class="col-md-9 aright">
                        <div class="banner">
                                <ul class="img">
                                        <li><a href="#"><img src="${APP_PATH}/static/images/first-page/1 figure.jpg"
                                                             alt="第1张图片"></a></li>
                                        <li><a href="#"><img src="${APP_PATH}/static/images/first-page/2 figure.jpg"
                                                             alt="第2张图片"></a></li>
                                        <li><a href="#"><img src="${APP_PATH}/static/images/first-page/3 figure.jpg"
                                                             alt="第3张图片"></a></li>
                                        <li><a href="#"><img src="${APP_PATH}/static/images/first-page/4 figure.jpg"
                                                             alt="第4张图片"></a></li>
                                        <li><a href="#"><img src="${APP_PATH}/static/images/first-page/5 figure.jpg"
                                                             alt="第5张图片"></a></li>
                                </ul>
                                <ul class="num"></ul>
                                <div class="btn btn1">
            ...
            success: function (result) {
                ...
                $.each(categorys,function (index,category) {
                    ...
                    var categoryItem = $("<div></div>").addClass("col_md_3")
                        .append($("<div style='height: 40px;'></div>").addClass("row clasi")
